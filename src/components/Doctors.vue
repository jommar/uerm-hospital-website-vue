  ...
  <div class="g-font-primary">
    ...
    <div class="g-bg-main py-3">
      <img
        ...
        src="assets/img/stock/doctors.jpg"
        alt="doctors"
      />
    </div>
    <div class="container">
      <div
        v-if="doctors.length == 0 && !isDoctorsLoaded"
      ...
      <div class="text-center my-3" v-if="isDoctorsLoaded">
        <span
          ...
          v-bind:class="{ active: curentLetter == '' }"
          v-on:click="filterDoctors('')"
          >All</span
        >
        <span
          class="btn btn-outline-primary m-2"
...
export default {
  ...
  data() {
    return {
      height: window.innerHeight > window.innerWidth ? "30vh" : "280px",
      doctors: [],
